          ...
          <div class="col-md-12">
            <div class="card" style="" >
              <div class="card-header">
                <h5 class="card-title" style="align-content: center; font-family: serif;">BANYAK DESA/KELURAHAN DI WILAYAH LERENG/PUNCAK</h5>
              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <p class="text-center">
                      <strong>Kabupaten/Kota Sul-Sel</strong>
                          ...
                          <div style="overflow-y: scroll; height: 490px;">
                            <tbody >
                              <?php foreach ($lereng as $des ): ?>
                            
                              <tr>
                                <span><?php echo $des['kabkot']; ?></span>
                                <span class="text-right" style="float: right;"><?php echo $des['AW_lereng']; ?> &nbsp; </span>
                              </tr>
                  ...
                  <div class="col-md-8">
                    ...
                    <!-- /.progress-group -->
    <?php 
    foreach ($lereng as $key ) {
       $aw_lereng[] = $key['AW_lereng'];
       $kabkots[] = $key['kabkot'];
...
?>
                ...
                return w >= <?php echo $data3+1 ?> && w <= <?php echo "$data4" ?> ? '#800026':
                  ...
                  function getinfo(kabkot , feature) {
                      ...
                      var awil_lereng = [<?php echo '"'.implode('","', $aw_lereng).'"'?>];


                      for (var i = 0; i < kabs.length; i++) {
                    if (kabkot == kabs[i] ) {
                       return warnawilad(awil_lereng[i]);
                    }
              ...
              for (var i = 0; i < kabs.length; i++) {
                    if ($d == kabs[i]) {
                      layer.bindTooltip( '<b>' + kabs[i]+'</b>' + " : " + awil_lereng[i] .toString(),   {hide : true});
